...
\end{equation}
    ...
    \captionsetup{labelformat=default}
    \begin{figure}
        \begin{center}\adjustimage{max size={1\linewidth}{0.4\paperheight}}{MotionRetargetingPaper-3_files/MotionRetargetingPaper-3_15_0.png}\end{center}
...
with the surface.
    ...
    \captionsetup{labelformat=default}
    \begin{figure}
        \begin{center}\adjustimage{max size={1\linewidth}{0.4\paperheight}}{MotionRetargetingPaper-3_files/MotionRetargetingPaper-3_19_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
